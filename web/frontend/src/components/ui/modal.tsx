  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        />
        <Dialog.Popup
          className="fixed inset-x-4 top-1/2 z-50 w-auto -translate-y-1/2 max-w-md mx-auto overflow-hidden rounded-2xl border border-border bg-card shadow-dialog animate-scale-in max-[420px]:inset-x-2 sm:inset-x-auto sm:w-full"
        >
